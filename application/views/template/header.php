        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul class="nav-inner">
                ...
                if (isset($_SESSION['perfil']) && ($_SESSION["baneado"] == 0)) {
                    ...
                    $empleados = ($activeTab == "empleados") ? "active" : "";

                    switch ($_SESSION['perfil']) {
                        case 1: // usuario
                            echo '<li class="' . $ofertas . '"><a href="' . base_url() . 'user/ofertas">Ofertas</a></li>';
                            break;

                        case 2: // empleado
                            echo '<li class="' . $ofertas . '"><a href="' . base_url() . 'empleado/ofertas">Ofertas</a></li>';
                            break;

                        case 3: // gerente
                            echo '<li class="' . $ofertas . '"><a href="' . base_url() . 'gerente/ofertas">Ofertas</a></li>';
                            echo '<li class="' . $empleados . '"><a href="' . base_url() . 'gerente/empleados">Empleados</a></li>';
                            break;
